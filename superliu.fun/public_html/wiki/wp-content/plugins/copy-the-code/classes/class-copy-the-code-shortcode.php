...
if ( ! class_exists( 'Copy_The_Code_Shortcode' ) ) :
	...
	class Copy_The_Code_Shortcode {
		...
		public function register() {
			...
			add_submenu_page(
				'options-general.php',
				__( 'Shortcode Info', 'copy-the-code' ),
				__( ' → Shortcode Info', 'copy-the-code' ),
				'manage_options',
				'shortcode',
		...
		public function shortcode_page_markup() {
			...
			<p><code>[copy content="100OFF"]</code></p>

			<p>It dispaly the "Copy" text on frontend and on click on it the string "100OFF" copied to clipboard.
			
			<p>We can change the "Copy" text with any other text as <code>text="Click Me"</code>.</p>
			<p>E.g. <code>[copy text="Click Me" content="100OFF"]</code></p>
			<p>Here we can see the text "Click Me" and on click on it the text "100OFF" copied to the clipboard.</p>
